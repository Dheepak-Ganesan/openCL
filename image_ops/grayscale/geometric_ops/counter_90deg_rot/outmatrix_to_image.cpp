...
int main()
{
    std::ifstream file("counter_90deg_rot.txt");
    if (!file.is_open()) {
        std::cerr << "Error: Could not open counter_90deg_rot.txt\n";
        return -1;
    }
    ...
    // Save the image
    cv::imwrite("counter_90deg_rot.png", img);

    std::cout << "Image saved as counter_90deg_rot.png\n";
    return 0;
}
