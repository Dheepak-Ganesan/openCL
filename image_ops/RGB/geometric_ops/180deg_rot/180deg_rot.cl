__kernel void rotate_180_clkWise(__global int* input,__global int* output,const int height,const int width,const int channels)
{
    ...
    */
    ...
    int rotate_180_clkWise_idx = gdep * height * width + new_row * width + new_col;
