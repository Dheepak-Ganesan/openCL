...
int main()
{
    ...
    kernel_180deg_rot.setArg(4, CHANNELS);

    CommandQueue.enqueueNDRangeKernel(kernel_180deg_rot, cl::NullRange, cl::NDRange(HEIGHT, WIDTH, CHANNELS));
    CommandQueue.finish();
    ...
    ofstream out_file("180deg_rot_3d.txt");
    ...
    out_file.close();
    cout << "Output 3D image saved to 180deg_rot_3d.txt\n";
}
